...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix mb-5"<?php print $attributes; ?>>
    ...
    <div class="row clearfix">
        <div class="col mb-2">
            ...
            <span class="float-right text-capitalize"><?php print render($content['field_event_type']);?></span>
        </div>
    </div>
    <div class="row">
        <div class="col mb-2">
    ...
    <div class="row">
        <div class="col">
            <span class="lead mb-2"><?php print render($content['field_event_ingress']);?></span>
